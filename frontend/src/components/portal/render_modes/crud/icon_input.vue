<template>
    <div class="icon-input">
        <div class="input-wrapper">
            <input type="text" v-model="searchTerm" @input="searchIcons" @focus="showDropdown = true"
                placeholder="Search for an icon..." class="w-full px-3 py-2 rounded-md" />
            <i v-if="selectedIcon" :class="selectedIcon" class="selected-icon"></i>
        </div>
...
// This would be your full list of icons, grouped by category
const allIcons = {
    'General': [
